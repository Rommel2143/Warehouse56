...
Public Class update_proddate
    Private Sub update_proddate_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        reload("SELECT `id`,`lotnumber`, `prod_date` FROM `logistics_unit6` WHERE prod_date IS NULL", datagrid1)
    End Sub
    ...
    Private Sub Guna2Button1_Click(sender As Object, e As EventArgs) Handles Guna2Button1.Click
        For Each row As DataGridViewRow In datagrid1.Rows
            ...
            Try
                    con.Open()
                Dim cmd As New MySqlCommand("UPDATE logistics_unit6 SET prod_date = @date WHERE id = @id", con)
