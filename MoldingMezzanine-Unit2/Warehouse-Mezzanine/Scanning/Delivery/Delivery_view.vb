...
Public Class Delivery_view
    ...
    Private Sub getGroup()
        Try
            ...
            Dim query As String = "SELECT lm.partname,lu.partcode,SUM(lu.qty) AS qty, COUNT(lu.id) AS count from logistics_mezzanine lu
                                ...
                                JOIN trc_user.logistics_user_unit56 l ON l.IDno = lu.userout
    ...
    Private Sub displayrecords()
        reload("SELECT logistics_mezzanine.id,`qrcode`, `partcode`, `lotnumber`, `supplier`, `remarks`, `qty`,dateout,`timeOUT` FROM `logistics_mezzanine` 
                 JOIN trc_user.logistics_user_unit56 lu ON lu.IDno = logistics_mezzanine.userout
    ...
    Private Sub Guna2DateTimePicker1_ValueChanged(sender As Object, e As EventArgs) Handles dtpicker1.ValueChanged
        Dim query As String = "SELECT CONCAT(lu.Firstname, ' ', lu.Lastname) AS Fullname 
                                 ...
                                 JOIN trc_user.logistics_user_unit56 lu ON lu.IDno = l.userout
