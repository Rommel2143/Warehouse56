...
Public Class Delivery
    ...
    Private Sub displayrecords()
        reload("SELECT `id`,`qrcode`, `partcode`, `lotnumber`, `supplier`, `remarks`, `qty`,boxno FROM `logistics_mezzanine` 
        ...
        Try
            ...
            If destination.Equals("Factory 2", StringComparison.OrdinalIgnoreCase) Then
               ...
               (Not rfid.StartsWith("E280116", StringComparison.OrdinalIgnoreCase) AndAlso
                ...
                ' OUT QR
                If outQR(qr, batch, boxNo, destination) Then
            ...
            Else
                ...
                outQR(qr, batch, boxNo, destination)
