...
Module userModules
    ...
    Public Function isLogin(IDno As String, pass As String) As Boolean
        Dim query As String = "SELECT IDno,Firstname,password FROM trc_user.logistics_user_unit56 WHERE IDno = @IDno AND password = @password"
    ...
    Public Function isAdmin() As Boolean
        Dim query As String = "SELECT admin FROM trc_user.logistics_user_unit56 WHERE IDno = @IDno"
